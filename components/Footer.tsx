        ...
        <div className="footer-grid">
          ...
          <div className="footer-col-brand">
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              <div style={{ width: 80, height: 80, borderRadius: 16, background: "rgba(212,160,23,0.1)", border: "1px solid rgba(212,160,23,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <img src="/logo-dark.png" alt="" style={{ width: 60, objectFit: "contain" }} />
              </div>
              <div>
