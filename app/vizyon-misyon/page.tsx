  ...
  return (
    <div className="legal-page">
      <div className="container" style={{ maxWidth: '800px' }}>
        <h1>Vizyon & <span className="gold">Misyon</span></h1>
        <div className="card legal-card">
          <h2 style={{ fontSize: 'clamp(1.15rem, 3vw, 1.5rem)', color: 'var(--dark)', marginBottom: '1rem', fontWeight: 800 }}>VİZYONUMUZ</h2>
          ...
          <h2 style={{ fontSize: 'clamp(1.15rem, 3vw, 1.5rem)', color: 'var(--dark)', marginBottom: '1rem', fontWeight: 800 }}>MİSYONUMUZ</h2>
          <p>
